      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-32">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center gap-6 mb-12">
            ...
            <button onClick={() => { addToCart(product, quantity); navigate('cart'); }} className="flex-grow bg-gray-900 text-white h-20 rounded-full font-bold text-xl hover:bg-primary transition-all shadow-2xl shadow-black/10 uppercase tracking-widest">Passer au Panier</button>
          </div>
